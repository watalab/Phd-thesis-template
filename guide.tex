...
\begin{enumerate}
    ...
    \item 結論
\end{enumerate}
の順序で書きます。ただし，D論では，各章が個別の研究テーマになりがちなので，各章ごとに手法・結果・考察を書くことになるかもしれません。

このテンプレートでは，論文全体の要旨を書くようにpreface.texを入れるようにしています。もし要旨を入れない場合は削除してください。
...
\begin{verbatim}
    \usepackage[style=phys, biblabel=brackets, backend=biber, 
